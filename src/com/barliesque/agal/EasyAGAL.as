package com.barliesque.agal {
	...
	public class EasyAGAL extends EasyBase {
		 ...
		 */
		protected function mov(dest:IField, source:IField):void {
		 ...
		 * @param	source2		Second source register or component selection
		 */
		protected function sub(dest:IField, source1:IField, source2:IField):void {
		 ...
		 * @param	source2		Second source register or component selection
		 */
		protected function mul(dest:IField, source1:IField, source2:IField):void {
		 ...
		 */
		protected function div(dest:IField, source1:IField, source2:IField):void {
		 ...
		 * @param	source		The source register or component selection
		 */
		protected function rcp(dest:IField, source:IField):void {
		 ...
		 * @param	source		The source register or component selection
		 */
		protected function frc(dest:IField, source:IField):void {
		 ...
		 * @param	source		The source register or component selection
		 */
		protected function sqt(dest:IField, source:IField):void {
		 ...
		 * @param	source		The source register or component selection
		 */
		protected function rsq(dest:IField, source:IField):void {
		 ...
		 */
		protected function nrm(dest:IField, source:IField):void {
		 ...
		 * @param	source		The source register or component selection
		 */
		protected function neg(dest:IField, source:IField):void {
		 ...
		 * @param	source		The source register or component selection
		 */
		protected function sat(dest:IField, source:IField):void {
		 ...
		 */
		protected function sge(dest:IField, source1:IField, source2:IField):void {
		 ...
		 * otherwise, it will be set to 0.</p>
		 */
		protected function slt(dest:IField, source1:IField, source2:IField):void {
		 ...
		 */
		/*
		protected function sgn(dest:IField, source:IField):void {
		...
		*/
		 ...
		 */
		protected function seq(dest:IField, source1:IField, source2:IField):void { //, temp:IRegister):void {
		 ...
		 * @param	source2		Value on the right side of the comparison
		 */
		protected function sne(dest:IField, source1:IField, source2:IField):void { //, temp:IRegister):void {
		 ...
		 **/
		protected function crs(dest:IField, source1:IField, source2:IField):void {
		 ...
		 * @param	source2		A three-component vector
		 **/
		protected function dp3(dest:IField, source1:IField, source2:IField):void {
		 ...
		 * @param	source2		A three-component vector
		 **/
		protected function dp4(dest:IField, source1:IField, source2:IField):void {
		 ...
		 */
		protected function m33(dest:IField, source1:IField, source2:IField):void {
		 ...
		 */
		protected function m44(dest:IField, source1:IField, source2:IField):void {
		 ...
		 */
		protected function m34(dest:IField, source1:IField, source2:IField):void {
			assembler.append("m34 " + dest["reg"] + ", " + source1["reg"] + ", " + source2["reg"]);
		}
		
		/**
		 * If the value passed is less than zero, the fragment is discarded and not drawn to the frame buffer.
		 * @param	source		A single component value
		 */
		protected function kil(source:IComponent):void {
		 ...
		 * @see TextureFlag
		 */
		protected function tex(dest:IField, source1:IField, source2:ISampler, flags:Array = null):void {
