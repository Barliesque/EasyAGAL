package com.barliesque.agal {
	...
	public class EasierAGAL extends EasyBase {
		 ...
		 */
		static protected function setIf_Equal(dest:IField, source1:IField, source2:IField, temp:IRegister):void {
		 ...
		 * @param	temp		A temporary register which will be utilized for this comparison
		 */
		static protected function setIf_NotEqual(dest:IField, source1:IField, source2:IField, temp:IRegister):void {
